                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="row col-md-6">
                                <label for="tipo_usuario_id" class="col-md-4 col-form-label text-md-right">{{ __('C° Usuario') }}</label>

                                <div class="col-md-8">
                                    <select name="tipo_usuario_id" id="tipo_usuario_id" class="form-control @error('tipo_usuario_id') is-invalid @enderror">
                                        @foreach ($tipo_usu as $tipo_us)
                                            <option value="{{$tipo_us['id']}}">{{$tipo_us['nombre']}}</option>
                                        @endforeach
                                    </select>
                                    {{-- <input id="tipo_usuario_id" type="text" class="form-control @error('tipo_usuario_id') is-invalid @enderror" name="tipo_usuario_id" value="{{ old('tipo_usuario_id') }}"  autocomplete="tipo_usuario_id" autofocus> --}}
